...
export function SubscriptionManagement() {
  ...
  const faqs = [
    ...
    {
      question: "How do the $2.99/month and $29.90/year plans compare?",
      answer: "Both plans grant full, unrestricted access to all Pro features globally. The Monthly plan ($2.99/mo) offers maximum flexibility, while the Yearly plan ($29.90/yr) saves you over 16% annually (equal to $2.49/mo) and guarantees non-stop global access for the entire year."
    },
    {
