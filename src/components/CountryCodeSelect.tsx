...
export function CountryCodeSelect({ value, onChange, className }: CountryCodeSelectProps) {
  return (
    <select 
      ...
      className={className || "w-full px-3 py-3 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#d11a2a] focus:ring-1 focus:ring-[#d11a2a]"}
    >
