...
const FAQ_DATA: FAQItem[] = [
  ...
  // Pro Plans & Payments
  {
    ...
    answer: 'Streamlify Pro is available for $2.99/month or $29.90/year (with local payment equivalents available). Pro unlocks unlimited tournament creation, broadcast-grade graphics overlay customization, AI match summary analytics, priority high-bandwidth stream rendering, and full player performance history.'
  },
  {
    id: 'sc-9',
    category: 'billing',
